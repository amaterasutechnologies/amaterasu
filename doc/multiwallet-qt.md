...
In order to support loading of multiple wallets in amaterasu-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is amaterasu.cpp.
...
Changes to amaterasu.cpp
----------------------
amaterasu.cpp is the entry point into amaterasu-qt, and as such, will require some minor modifications to provide hooks for
