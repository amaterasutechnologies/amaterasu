Contributing to amaterasu Core
============================

The amaterasu Core project operates an open contributor model where anyone is
...
The following applies to code changes to the amaterasu Core project, and is not to be
confused with overall amaterasu Network Protocol consensus changes.

Whether a pull request is merged into amaterasu Core rests with the project merge
...
Patches that change amaterasu consensus rules are considerably more involved than
...
Where a patch set proposes to change the amaterasu consensus, it must have been
...
The project leader is the release manager for each amaterasu Core release.
