...
This means one can have an always-on amaterasud instance running, and another local amaterasud/amaterasu-qt instance which connects to this node and receives blocks from it.
