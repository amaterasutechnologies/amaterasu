...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("amaterasu amaterasu-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  amaterasu-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded amaterasu transaction") + "\n" +
                               "  amaterasu-tx [options] -create [commands]   " + _("Create hex-encoded amaterasu transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded amaterasu transaction
