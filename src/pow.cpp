...
// Copyright (c) 2021 The amaterasu developers
...
unsigned int GetLegacyNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader* pblock, bool fProofOfStake)
{
    ...
    // amaterasu coin: target change every block
    // amaterasu coin: retarget with exponential moving toward target spacing
    uint256 bnNew;
