...
/* amaterasu GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "amaterasu"
#define QAPP_ORG_DOMAIN "amaterasuproject.org"
#define QAPP_APP_NAME_DEFAULT "amaterasu-Qt"
#define QAPP_APP_NAME_TESTNET "amaterasu-Qt-testnet"
