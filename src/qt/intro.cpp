...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("amaterasu Core"),
     ...
     * override -datadir in the amaterasu.conf file in the default data directory
     * (to be consistent with amaterasud behavior)
     */
    if (dataDir != getDefaultDataDirectory())
